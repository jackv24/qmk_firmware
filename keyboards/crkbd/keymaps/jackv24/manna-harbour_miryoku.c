...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [GAME] = LAYOUT_miryoku(
    KC_TAB,  KC_Q,   KC_C,   KC_E,    KC_R,   KC_NO,  KC_NO,   KC_NO,   KC_NO,  KC_NO,
    KC_LSFT, KC_A,   KC_W,   KC_D,    KC_F,   KC_NO,  KC_LEFT, KC_UP, KC_RIGHT,  KC_NO,
    KC_Z,    KC_X,   KC_S,   KC_V,    KC_I,   KC_NO,  KC_NO,   KC_DOWN,   KC_NO,  KC_NO,
